...
from backend.services.patient_content_service import extract_patient_content, strip_speaker_labels
...
async def transcribe_endpoint(
    ...
    try:
        ...
        patient_transcript = strip_speaker_labels(extract_patient_content(translated_transcript))
